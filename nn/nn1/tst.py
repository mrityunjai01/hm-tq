...
from nn.nn1.gen_functions import gen_x


def create_model_guesser(model, verbose=False):
    """
    ...
    def guess_fn(current_word: str) -> str:
        ...
        raw_predictions: NDArray[np.float32] = model.predict_numpy(gen_x(current_word))
