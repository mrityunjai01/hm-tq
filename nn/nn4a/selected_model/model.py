...
class HangmanNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer3 = nn.Linear(hidden_dim1 * (input_dim + 1), 26)  # Output 26 letters
        self._init_weights()
    ...
    def forward(self, x):
        ...
        combined_embed = torch.cat([surr_embed, pos_embed_expanded], dim=1)  # (batch_size, 35, embed_dim)
